        ...
        <div id="product-form" class="p-3 mx-auto md:w-2/3 mt-5 rounded-lg border shadow-md border-gray-300">
            ...
            <form class="" @submit.prevent>
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="name" v-model="product.name" ref="product_name"
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="price" v-model="product.price" ref="product_price"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" ">
                        <label for="price"
                ...
                <div class="w-full mb-6">
                    <textarea name="desc" id="desc" rows="4" ref="product_desc"
    ...
    methods: {
        async updateProduct() {
            var data = {
                ...
                "price": this.$refs.product_price.value,
                "selling_price": this.$refs.product_selling_price.value,
                "desc": this.$refs.product_desc.value
            };
            await axios.patch(
                `/api/product/${this.id}/`,
                data,
            ...
            } else if (this.resp.status >= 400) {
                alert(this.resp.data);
            }
        }
    },
