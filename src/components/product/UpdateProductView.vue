<template>
  <div class="container p-3">
    <div
      id="product-form"
      class="p-3 mx-auto relative md:w-2/3 mt-5 rounded-lg border shadow-md border-gray-300"
    >
    <loading-bar-contain/>
      <div class="heading">
...
export default {
  ...
  async created() {
    var response = await new APIService(`/api/product/${this.uuid}`).get();
